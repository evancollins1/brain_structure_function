...
addpath(genpath('structural_connectivity_metrics_functions'));

% file path
mat_file_path = [pwd  '/../data/connectivity/optimized_sc/hcp_group_mtrx_1065.mat'];
...
%%
save([pwd  '/../data/connectivity/optimized_sc/optimized_sc_rsq.mat'], 'rsq')
save([pwd  '/../data/connectivity/optimized_sc/optimized_sc_predictors.mat'], 'a','abin','d','PLbin','PLwei','Gwei','Gbin','Coswei','Cosbin','SIbin','SIwei','PTbin','PTwei','MIwei','MIbin','Navnumhops','NavplMS','mfptwei','mfptbin','FGbin','FGwei')