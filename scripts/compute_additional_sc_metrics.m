...
addpath(genpath('sc_metrics_functions'));

% file path
mat_file_path = [pwd  '/../data/connectivity/additional_sc_metrics/eucldist_wmpathcount_fcneurosynth.mat'];
...
mats = cat(3,a,abin,d,PLbin,PLwei,Gwei,Gbin,Coswei,Cosbin,SIbin,SIwei,PTbin,PTwei,MIwei,MIbin,Navnumhops,NavplMS,mfptwei,mfptbin,FGbin,FGwei); %mfptwei,mfptbin,,FGbin,FGweiSIbin,SIwei,,Gwei
...
%%
% save([pwd  '/../data/connectivity/optimized_sc/optimized_sc_metrics_by_parcel.mat'], 'rsq')
 save([pwd  '/../data/connectivity/optimized_sc/additional_sc_metrics_neurosynth.mat'], 'a','abin','d','PLbin','PLwei','Gwei','Gbin','Coswei','Cosbin','SIbin','SIwei','PTbin','PTwei','MIwei','MIbin','Navnumhops','NavplMS','mfptwei','mfptbin','FGbin','FGwei')